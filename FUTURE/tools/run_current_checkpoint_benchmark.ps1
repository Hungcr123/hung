...
$stdout = 'C:\Users\Admin\.codex\plans\server2_postgres_full_audit\checkpoint_007_benchmark_18877.out.log'
$stderr = 'C:\Users\Admin\.codex\plans\server2_postgres_full_audit\checkpoint_007_benchmark_18877.err.log'
...
try {
  $env:FUTURE_PG_DSN = $env:FUTURE_PG_DSN
  python FUTURE\tools\benchmark_common_overlay_spacev_checkpoint.py --base http://127.0.0.1:18877 --port 18877 --prefix checkpoint_007_common_overlay_spacev_current --warmup-rounds 5 --rounds 30
}
finally {
