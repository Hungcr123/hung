"""PostgreSQL runtime repository for Space PDF/Picture AI state documents."""
...
def is_space_pdf_ai_document(path: Path | str) -> bool:
    return Path(path).name.lower() in SPACE_PDF_AI_NAMES
