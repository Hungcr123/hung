"""PostgreSQL runtime repository for viewer/tool bridge state documents."""
...
VIEWER_TOOL_SUFFIXES = (
    "_viewer_state.json",
    "_side_viewer_bridge.json",
    "_main_pdf_tool_state.json",
    "_image_viewer_state.json",
)


def is_viewer_tool_document(path: Path | str) -> bool:
    return Path(path).name.lower().endswith(VIEWER_TOOL_SUFFIXES)
