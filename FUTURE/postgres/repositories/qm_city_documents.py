"""PostgreSQL runtime repository for QM City and shared-world documents."""
...
def is_qm_city_document(path: Path | str) -> bool:
    return Path(path).name.lower() in QM_CITY_DOCUMENT_NAMES
