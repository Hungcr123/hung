...
SPEC_PATH = ROOT / "space_l_calm_focus_listening_spec.json"
OUTPUT_PATH = Path("C:/server data/common/Space_L_Calm_Focus_Listening.Space_L")


def main() -> None:
    spec = json.loads(SPEC_PATH.read_text(encoding="utf-8"))
    payload = normalize_paragraph_payload(spec)
    payload["space_mode"] = "space_l"
    payload["format"] = "space_l hidden listening"
